...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/NGLScene.h include/Particle.h include/Emitter.h include/Cell.h $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/NGLScene.cpp src/Particle.cpp src/Emitter.cpp src/Cell.cpp $(DISTDIR)/
